    ...
    return (
      <div className="bg-white fixed w-full">
        <div className="max-w-8xl mx-auto flex flex-row justify-around items-center p-2">
              ...
              <div className="m-2">
                <Link to="/cart">
                  <button className="py-4 px-1 relative border-2 border-transparent text-gray rounded-full hover:text-gray-400 focus:outline-none focus:text-gray-500 transition duration-150 ease-in-out" aria-label="Cart">
